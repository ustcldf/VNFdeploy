                ...
                while(self.rich_or_poor(hp_value) == False and len(hp_c_backup) != 0):     
                    ...
                    for hr_id,hr_value in host_rich.iteritems():
                        if self.sl_in_ll(req_vnf_list, hr_value.vnf_container) and self.req_to_host(hp_value.req_container_dict[req_id], hr_value):
                            ...
                            condidate_d_dict[hr_id] = self.calc_d_val(host_matrix, req_matrix)
                        ...
                        if k in host_candinate:    #the id must in host_candinate
                            if k == i:
                                ...
                                if VNF_t_dict[k].has_key(VNF_min_dict[i]):                    #ensure that host_to_receive has the same vnf
                                    ...
                                    host_2r_d[k] = self.calc_d_val(VNF_i_mtr, h_2r_mtr)
...
def VNF_simulation_xFit_randomized(data_back):
    ...
    #with open('G:/ldf/simulation/data_store/host_lib_NF_r.pickle', 'w') as f:
    ...
    with open('G:/ldf/simulation/data_store/saved_info_dict_NF_r.json', 'w') as f:
    ...
    #with open('G:/ldf/simulation/data_store/host_lib_FF_r.pickle', 'w') as f:
    ...
    with open('G:/ldf/simulation/data_store/saved_info_dict_FF_r.json', 'w') as f:
    ...
    #with open('G:/ldf/simulation/data_store/host_lib_FFD_r.pickle', 'w') as f:
    ...
    with open('G:/ldf/simulation/data_store/saved_info_dict_FFD_r.json', 'w') as f:
    ...
    #with open('G:/ldf/simulation/data_store/host_lib_BF_r.pickle', 'w') as f:
    ...
    with open('G:/ldf/simulation/data_store/saved_info_dict_BF_r.json', 'w') as f:
    ...
    #with open('G:/ldf/simulation/data_store/host_lib_BFD_r.pickle', 'w') as f:
    ...
    with open('G:/ldf/simulation/data_store/saved_info_dict_BFD_r.json', 'w') as f:
...
def VNF_simulation_xFit_non_randomized(data_back):
    ...
    with open('G:/ldf/simulation/data_store/host_lib_NF_nr.pickle', 'w') as f:
        pickle.dump(host_lib_nf,f)
    saved_info_dict_nf = {}
    saved_info_dict_nf[0] = host_id_nf+1
    saved_info_dict_nf[1] = pod_adjust_saved_num_nf
    saved_info_dict_nf[2] = len(saved_host_nf)
    saved_info_dict_nf[3] = saved_host_nf
    with open('G:/ldf/simulation/data_store/saved_info_dict_NF_nr.json', 'w') as f:
        json.dump(saved_info_dict_nf,f)
    ...
    with open('G:/ldf/simulation/data_store/host_lib_FF_nr.pickle', 'w') as f:
        pickle.dump(host_lib_ff,f)
    saved_info_dict_ff = {}
    saved_info_dict_ff[0] = host_id_ff+1
    saved_info_dict_ff[1] = pod_adjust_saved_num_ff
    saved_info_dict_ff[2] = len(saved_host_ff)
    saved_info_dict_ff[3] = saved_host_ff
    with open('G:/ldf/simulation/data_store/saved_info_dict_FF_nr.json', 'w') as f:
        json.dump(saved_info_dict_ff,f)
    ...
    with open('G:/ldf/simulation/data_store/host_lib_FFD_nr.pickle', 'w') as f:
        pickle.dump(host_lib_ffd,f)
    saved_info_dict_ffd = {}
    saved_info_dict_ffd[0] = host_id_ffd+1
    saved_info_dict_ffd[1] = pod_adjust_saved_num_ffd
    saved_info_dict_ffd[2] = len(saved_host_ffd)
    saved_info_dict_ffd[3] = saved_host_ffd
    with open('G:/ldf/simulation/data_store/saved_info_dict_FFD_nr.json', 'w') as f:
        json.dump(saved_info_dict_ffd,f)
    ...
    with open('G:/ldf/simulation/data_store/host_lib_BF_nr.pickle', 'w') as f:
        pickle.dump(host_lib_bf,f)
    saved_info_dict_bf = {}
    saved_info_dict_bf[0] = host_id_bf+1
    saved_info_dict_bf[1] = pod_adjust_saved_num_bf
    saved_info_dict_bf[2] = len(saved_host_bf)
    saved_info_dict_bf[3] = saved_host_bf
    with open('G:/ldf/simulation/data_store/saved_info_dict_BF_nr.json', 'w') as f:
        json.dump(saved_info_dict_bf,f)
    ...
    with open('G:/ldf/simulation/data_store/host_lib_BFD_nr.pickle', 'w') as f:
        pickle.dump(host_lib_bfd,f)
    saved_info_dict_bfd = {}
    saved_info_dict_bfd[0] = host_id_bfd+1
    saved_info_dict_bfd[1] = pod_adjust_saved_num_bfd
    saved_info_dict_bfd[2] = len(saved_host_bfd)
    saved_info_dict_bfd[3] = saved_host_bfd
    with open('G:/ldf/simulation/data_store/saved_info_dict_BFD_nr.json', 'w') as f:
        json.dump(saved_info_dict_bfd,f)
